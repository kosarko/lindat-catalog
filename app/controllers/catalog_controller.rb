...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'harvestedFrom', label: 'Harvested from', show: false, limit: -1
    config.add_facet_field 'dataProvider_ssi', label: 'Data provider', show: false, limit: -1
    ### ///
    ...
    config.add_sort_field 'relevance', sort: 'score desc, displayName_ssort asc', label: 'relevance'
    config.add_sort_field 'displayName', sort: 'displayName_ssort asc', label: 'display name'
